...
btu7=Button(root,padx=24,pady=18,bd=8, fg="red",font=('arial',20,'bold'),
...
btu9=Button(root,padx=24,pady=18,bd=8, fg="red",font=('arial',20,'bold'),
            text="9",bg="black",command=lambda:btnclick(9)).grid(row=1,column=2)

Addition=Button(root,padx=24,pady=18,bd=8, fg="green",font=('arial',20,'bold'),
            text="+",bg="black",command=lambda:btnclick("+")).grid(row=1,column=3)
#==========================================================================
btn4=Button(root,padx=24,pady=18,bd=8, fg="red",font=('arial',20,'bold'),
            text="4",bg="black",command=lambda:btnclick(4)).grid(row=2,column=0)

btn5=Button(root,padx=24,pady=18,bd=8, fg="red",font=('arial',20,'bold'),
...
Subtraction=Button(root,padx=24,pady=18,bd=8, fg="blue",font=('arial',20,'bold'),
            text="-",bg="black",command=lambda:btnclick("-")).grid(row=2,column=3)
#==========================================================================
btn1=Button(root,padx=24,pady=18,bd=8, fg="red",font=('arial',20,'bold'),
            text="1",bg="black",command=lambda:btnclick(1)).grid(row=3,column=0)

btn2=Button(root,padx=24,pady=18,bd=8, fg="red",font=('arial',20,'bold'),
...
Multiply=Button(root,padx=24,pady=18,bd=8, fg="yellow",font=('arial',20,'bold'),
            text="*",bg="black",command=lambda:btnclick("*")).grid(row=3,column=3)
#==========================================================================
btn0=Button(root,padx=24,pady=18,bd=8, fg="red",font=('arial',20,'bold'),
            text="0",bg="black",command=lambda:btnclick(0)).grid(row=4,column=0)

btnClear=Button(root,padx=24,pady=18,bd=8, fg="white",font=('arial',20,'bold'),
            text="C",bg="black",command=btnClearDisplay).grid(row=4,column=1)

btnEquals=Button(root,padx=24,pady=18,bd=8, fg="grey",font=('arial',20,'bold'),
            text="=",bg="black",command=btnEqualsInput).grid(row=4,column=2)

Division=Button(root,padx=24,pady=18,bd=8, fg="lightblue",font=('arial',20,'bold'),
